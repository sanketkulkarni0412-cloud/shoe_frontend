...
export default function SignUpPage() {
    const { signupWithEmail, signInWithGoogle } = useAuth(); // Changed loginWithGoogle to signInWithGoogle
    const [isFormLoading, setIsFormLoading] = useState(false); // Changed isLoading to isFormLoading
    ...
    const [confirmPassword, setConfirmPassword] = useState(''); // Kept confirmPassword as it's used in validateForm

    const searchParams = useSearchParams(); // Added searchParams
    const redirect = searchParams.get('redirect') || '/'; // Added redirect
        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-md bg-secondary p-8 rounded-lg border border-white/5 relative overflow-hidden">
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <h1 className="text-3xl font-bold uppercase tracking-wider">Join the Club</h1>
                    <p className="text-gray-400 mt-2">Create your account to unlock exclusive members-only benefits.</p>
                </div>
